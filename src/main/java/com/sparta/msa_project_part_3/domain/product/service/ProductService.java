...
public class ProductService {
  ...
  public ProductListResponse getProducts(String category, Boolean isOrderable, Pageable pageable) {
    Page<Product> products = productRepository.searchProducts(
        null,
        category,
        null,
    ...
    return ProductListResponse.of(products.map(ProductResponse::from));
  }
}